...
export const CURRICULUM = {
  'Junior KG': {
    ...
    Math: [
      ...
      { id: 'jk-ma-shapes', label: 'Shapes', emoji: '🔺', description: 'Sort each shape into the right bin', playable: 'ShapeSort' },
      { id: 'jk-ma-patterns', label: 'Patterns', emoji: '🧩' },
    ],
    EVS: [
      { id: 'jk-ev-habits', label: 'Good Habits & Manners', emoji: '🙏' },
      { id: 'jk-ev-living', label: 'Living & Non-Living Things', emoji: '🌱', description: 'Sort each thing into the right bin', playable: 'LivingOrNot' },
      { id: 'jk-ev-traffic', label: 'Traffic Rules & Safety', emoji: '🚦', description: 'Beat the clock — Stop, Wait, or Go', playable: 'StopOrGo' },
      { id: 'jk-ev-body', label: 'Parts of the Body', emoji: '🧍', description: 'Point to the body part named aloud', playable: 'PointToThe' },
      { id: 'jk-ev-animals', label: 'Animals', emoji: '🐘' },
      { id: 'jk-ev-veggies', label: 'Vegetables & Fruits', emoji: '🥕' },
      { id: 'jk-ev-helpers', label: 'Community Helpers', emoji: '👮', description: 'Match each tool to the helper who uses it', playable: 'WhoUsesThis' },
    ],
  },
  ...
  'Senior KG': {
    ...
    Math: [
      ...
      { id: 'sk-ma-time', label: 'Time', emoji: '🕐', description: 'Read a real analog clock face', playable: 'WhatTimeIsIt' },
      { id: 'sk-ma-addsub', label: 'Addition & Subtraction', emoji: '➕' },
      { id: 'sk-ma-money', label: 'Money', emoji: '🪙', description: 'Tap coins to make the target amount', playable: 'MakeAmount' },
      { id: 'sk-ma-skipcount', label: 'Skip Counting', emoji: '⏭️' },
      { id: 'sk-ma-colors', label: 'Colors', emoji: '🎨', description: 'Spot the one that\'s different', playable: 'OddOneOut' },
    ],
    EVS: [
      { id: 'sk-ev-self', label: 'Myself, Family & School', emoji: '👨‍👩‍👧' },
      { id: 'sk-ev-seasons', label: 'Seasons', emoji: '🍂', description: 'Pick the right outfit for the season', playable: 'DressForSeason' },
      { id: 'sk-ev-transport', label: 'Transportation', emoji: '🚗' },
      { id: 'sk-ev-animals', label: 'Animals & Their Sounds', emoji: '🐄', description: 'Match the sound to the animal', playable: 'WhoSaysThat' },
    ],
  },
  ...
  'Grade 1': {
    ...
    Math: [
      ...
      { id: 'g1-ma-num10to20', label: 'Numbers 10 to 20', emoji: '🔢', description: 'Fill the missing number in the sequence', playable: 'NumberLineGap' },
      ...
      { id: 'g1-ma-measurement', label: 'Measurement', emoji: '📏', description: 'Which one is bigger or smaller?', playable: 'BiggerOrSmaller' },
      { id: 'g1-ma-num21to99', label: 'Numbers 21 to 99', emoji: '💯' },
      { id: 'g1-ma-patterns', label: 'Patterns', emoji: '🧩', description: 'Figure out what comes next', playable: 'WhatComesNext' },
      { id: 'g1-ma-time', label: 'Time', emoji: '🕐' },
      { id: 'g1-ma-multiplication', label: 'Multiplication (Intro)', emoji: '✖️', description: 'Count groups to find the total', playable: 'GroupsOf' },
      { id: 'g1-ma-money', label: 'Money', emoji: '🪙' },
      { id: 'g1-ma-data', label: 'Data Handling', emoji: '📊', description: 'Read the chart to find the answer', playable: 'ReadTheChart' },
    ],
    EVS: [
