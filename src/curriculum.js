...
export const CURRICULUM = {
  ...
  'Senior KG': {
    English: [
      ...
      { id: 'sk-en-vocab', label: 'Vocabulary from Stories', emoji: '📚', description: 'Pop the balloon word that finishes the story', playable: 'StoryBalloon', total: 8 },
      { id: 'sk-en-sentences', label: 'Simple Sentences', emoji: '✏️', description: 'Snap word blocks into the right order', playable: 'SentenceBlocks', total: 8 },
    ],
    Math: [
      { id: 'sk-ma-opposites', label: 'Opposites', emoji: '↔️', description: 'Match each word to its opposite', playable: 'OppositesMatch', total: 2 },
      { id: 'sk-ma-shapes', label: 'Shapes', emoji: '🔷', description: 'Be a detective and find every hidden shape', playable: 'ShapeDetective', total: 8 },
      { id: 'sk-ma-numbers100', label: 'Numbers up to 100', emoji: '💯', description: 'Read the price tags and shop for the right toy', playable: 'PriceTag', total: 10 },
      { id: 'sk-ma-time', label: 'Time', emoji: '🕐', description: 'Read a real analog clock face', playable: 'WhatTimeIsIt', total: 12 },
      { id: 'sk-ma-addsub', label: 'Addition & Subtraction', emoji: '➕', description: 'Pick the number that balances the seesaw', playable: 'Seesaw', total: 10 },
      { id: 'sk-ma-money', label: 'Money', emoji: '🪙', description: 'Tap coins to make the target amount', playable: 'MakeAmount', total: 10 },
      { id: 'sk-ma-skipcount', label: 'Skip Counting', emoji: '⏭️', description: 'Help the frog hop by 2s, 5s and 10s', playable: 'LilyPad', total: 8 },
      { id: 'sk-ma-colors', label: 'Colors', emoji: '🎨', description: 'Spot the one that\'s different', playable: 'OddOneOut', total: 10 },
    ],
    EVS: [
      { id: 'sk-ev-self', label: 'Myself, Family & School', emoji: '👨‍👩‍👧', description: 'Walk Mia to the right place in her day', playable: 'SchoolDay', total: 8 },
      { id: 'sk-ev-seasons', label: 'Seasons', emoji: '🍂', description: 'Pick the right outfit for the season', playable: 'DressForSeason', total: 6 },
      { id: 'sk-ev-transport', label: 'Transportation', emoji: '🚗', description: 'Race each vehicle down road, rail, water or sky', playable: 'LaneRace', total: 8 },
  ...
  'Grade 1': {
    English: [
      { id: 'g1-en-alphabet', label: 'Alphabet Recognition', emoji: '🔠', description: 'Fill the missing letters on the alphabet ladder', playable: 'AlphabetLadder', total: 8 },
      { id: 'g1-en-phonetics', label: 'Phonetics', emoji: '🔊', description: 'Find the missing sound in each word', playable: 'SoundBlender', total: 10 },
      { id: 'g1-en-sentences', label: 'Simple Sentence Formation', emoji: '📝', description: 'Build a caterpillar sentence about the picture', playable: 'Caterpillar', total: 8 },
      { id: 'g1-en-grammar', label: 'Basic Grammar', emoji: '📘', description: 'Find and fix the robot\'s broken word', playable: 'RobotFix', total: 8 },
    ],
    // Chapter names from NCERT "Joyful Mathematics" for Class 1
    Math: [
      { id: 'g1-ma-prenum', label: 'Pre-Number Concepts', emoji: '🐱', description: 'More or fewer, tallest or shortest, the same', playable: 'WhichMore', total: 10 },
      { id: 'g1-ma-shapes', label: 'What is Long? What is Round?', emoji: '🔺', description: 'Will it roll or slide? Is it long or round?', playable: 'RollOrSlide', total: 10 },
      { id: 'g1-ma-num1to9', label: 'Numbers 1 to 9', emoji: '9️⃣', description: 'Catch the fish with the right number', playable: 'NumberFishing', total: 10 },
      ...
      { id: 'g1-ma-addsub20', label: 'Addition & Subtraction up to 20', emoji: '➖', description: 'Chain equation dominoes together', playable: 'Dominoes', total: 8 },
      ...
      { id: 'g1-ma-num21to99', label: 'Numbers 21 to 99', emoji: '💯', description: 'Build and read numbers with tens and ones', playable: 'PlaceValue', total: 10 },
      { id: 'g1-ma-patterns', label: 'Patterns', emoji: '🧩', description: 'Figure out what comes next', playable: 'WhatComesNext', total: 10 },
      { id: 'g1-ma-time', label: 'Time', emoji: '🕐', description: 'Put the day in order and learn the week', playable: 'DayOrder', total: 8 },
      ...
      { id: 'g1-ma-money', label: 'Money', emoji: '🪙', description: 'Add prices, give change and check your wallet', playable: 'GiveChange', total: 10 },
    ...
    EVS: [
      ...
      { id: 'g1-ev-clothes', label: 'Our Clothes', emoji: '👕', description: 'Dress for the weather, the job or the day', playable: 'Wardrobe', total: 8 },
      { id: 'g1-ev-house', label: 'Our House', emoji: '🏠', description: 'Send everything to the right room', playable: 'RoomCatch', total: 10 },
      { id: 'g1-ev-family', label: 'My Family', emoji: '👨‍👩‍👧‍👦', description: 'Solve riddles on the family tree', playable: 'FamilyTree', total: 8 },
      { id: 'g1-ev-school', label: 'My School', emoji: '🏫', description: 'Pack the school bag for today\'s plan', playable: 'Backpack', total: 8 },
      ...
      { id: 'g1-ev-animals', label: 'Animals Around Us', emoji: '🐘', description: 'Guess the animal from its clues', playable: 'AnimalRiddle', total: 8 },
