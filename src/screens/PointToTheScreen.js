...
export default function PointToTheScreen({ route, navigation }) {
  ...
  return (
    <LinearGradient colors={[colors.cream, colors.grass + '22']} style={styles.container}>
      ...
      <Text style={styles.prompt}>Point to the</Text>
      <Text style={styles.target}>{round.label}</Text>
...
const styles = StyleSheet.create({
  ...
  prompt: { fontFamily: fonts.bodyBold, fontSize: 16, color: colors.muted, marginTop: spacing.lg },
  target: { fontFamily: fonts.displayBold, fontSize: 32, color: colors.grapeDeep, marginBottom: spacing.lg },
